...
A fleet-monitoring dashboard for a personal homelab. Custom [SvelteKit](https://kit.svelte.dev/) frontend on top of [Beszel](https://github.com/henrygd/beszel) for metrics collection, designed to run tailnet-only via [Tailscale](https://tailscale.com/) so it isn't reachable from the public internet.
